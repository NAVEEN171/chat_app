...
const avengers = [
  ...
  {
    image:
      "https://www.tomsguide.fr/content/uploads/sites/2/2020/05/mjolnir.jpg",
  },
  {
    image:
      "https://e0.pxfuel.com/wallpapers/468/165/desktop-wallpaper-iron-man-snap-iron-man-endgame.jpg",
  },
  {
    image:
  ...
  {
    image:
      "https://qph.cf2.quoracdn.net/main-qimg-91e23d9ce0a0bca3e565e1e4fc5eb617-pjlq",
  },
  {
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTorpF9mKMLlG4t_B4UPLZxJB9u2CybXz847AT-mZVu7aPBFe8nTH89WNr5ZcwwkHtNc1Y&usqp=CAU",
  },
  {
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSF3uUTRPtHgpK7dyyPCYniu4kt3lPooDy_wQ&usqp=CAU",
  },
];
const Avatar = () => {
  ...
  const submithandle = async (event) => {
    ...
    if (selected !== "") {
      ...
      let data = await fetch(
        `${process.env.REACT_APP_DEPLOYMENT_BACKEND}/Setavatar/${
          user.insertedId || user._id
        }`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <Fragment>
      <div className="avatarselection">Select Avatar</div>
      <div className="avatarwrapper">
        <div className="avatars">
          {avengers.map((avenn, index) => (
            <div
              key={index}
              id={index}
              onClick={(e) => {
              ...
              className="aven"
              style={{ backgroundImage: `url(${avenn.image})` }}
            ></div>
          ))}
        </div>
      </div>
      <div className="bottom-wrapper">
        ...
        <div className="imagewrapper">
          <div className="imagepreview">Photo preview :</div>
          <img
            className="avenn"
            src={
              previewurl

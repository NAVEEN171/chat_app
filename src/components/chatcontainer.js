...
setshow(!show)
 ...
 onBlur={blurhandler} id="typinginput" value={msg} onClick={()=>{setshow(false)}} onChange={(e)=>{messagechangehandle(e)}}  className="message" placeholder="your message"></textarea>
